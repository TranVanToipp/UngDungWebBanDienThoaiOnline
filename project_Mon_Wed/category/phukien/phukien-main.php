        ...
        <div class="row">
            <div class="col l-3 shop-danhmuc">
                <div class="shop-danhmuc-header">
                    <span>PHỤ KIỆN <?=$product_type?></span>
                </div>
			...
			<div class="col l-9 shop-sanpham">
                <div class="shop-sanpham-title">
                    <?php
						$sql = "SELECT count(ID) as number FROM tblsanpham WHERE loaiSP='PK".$id_type."'";
                        $data = executeResult($sql);
                        $number = 0;
			...
			<div class="row">
				<?php
						$sql = "SELECT * FROM tblsanpham WHERE loaiSP='PK".$id_type."'";
						...
						echo
							'<div class="col l-4 c-6 product-selling-items shop-cuahang-items">
								<div class="product-selling-box-img">
									<a href="../../../../project_Mon_Wed/category/ctSP/sp.php?sp='.$sp['MaSP'].'"><img class="product-selling-img" src="../../../admin/product/'.$sp['HinhSP'].'" alt="hình phụ kiện"></a>
								</div>
